...
#
# def is_image_relevant(image_content, keyword):
...
#                     # 判断图片是否与关键词相关
#                     image_similarity = is_image_relevant(image_content, keywords)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_pics", type=int, default=100, help="每个关键词的最大图片数量")
    args = parser.parse_args()
    image_downloader = ImageDownloader(args.keywords, args.max_pics)
